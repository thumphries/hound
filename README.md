...
[![Build Status](https://travis-ci.org/thumphries/hound.svg?branch=master)](https://travis-ci.org/thumphries/hound) 
...
```
go get github.com/thumphries/hound/cmds/...
```
...
```
git clone https://github.com/thumphries/hound.git ${GOPATH}/src/github.com/thumphries/hound
cd ${GOPATH}/src/github.com/thumphries/hound
make
```

If this is your only Go project, you can set your GOPATH just for Hound:
```
git clone https://github.com/thumphries/hound.git src/github.com/thumphries/hound
GOPATH=$(pwd) make -C src/github.com/thumphries/hound
```
